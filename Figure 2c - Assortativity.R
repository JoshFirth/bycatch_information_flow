...
p3<-load("Data/edge perms 1.RData")
p4<-load("Data/edge perms 2.RData")

#In assortment - across contexts:
net.function<-function(a){assortativity(a,degree(a,mode="in"))}
...
mag<-0.02 #mag is how much to stretch the distributions up and down (i.e. their overall size)
